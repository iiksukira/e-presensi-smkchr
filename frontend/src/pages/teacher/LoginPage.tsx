...
const LoginPage: React.FC = () => {
  ...
  const roleConfig = {
    ...
    icon: <TeamOutlined />,
    color: "#8c9600",
    bgGradient: "linear-gradient(135deg, #8c9600 0%, #6b7a00 100%)",
  ...
  const onFinish = async (values: LoginPayload) => {
    ...
    try {
      ...
      setTimeout(() => {
        if (user.role === "guru") navigate("/teacher/dashboard");
        else navigate("/login");
      }, 500);
    } catch (error) {
      const errorMsg =
          ...
          >
            ...
            <div style={{ padding: "32px 32px 40px 32px" }}>
              ...
              >
                ...
                >
                  <Input
                    prefix={<UserOutlined style={{ color: "#8c9600" }} />}
                    ...
                    onFocus={(e) => {
                      e.target.style.borderColor = "#8c9600";
                      e.target.style.boxShadow =
                        "0 0 0 2px rgba(140,150,0,0.1)";
                    }}
                    onBlur={(e) => {
                ...
                >
                  <Input.Password
                    prefix={<LockOutlined style={{ color: "#8c9600" }} />}
