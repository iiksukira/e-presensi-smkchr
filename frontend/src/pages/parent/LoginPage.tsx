...
const LoginPage: React.FC = () => {
  ...
  const roleConfig = {
    ...
    icon: <TeamOutlined />,
    color: "#910000",
    bgGradient: "linear-gradient(135deg, #910000 0%, #910000 100%)",
    redirectPath: "/parent",
  };
  ...
  useEffect(() => {
    ...
    if (token && (user.role === "ortu" || user.role === "orangtua")) {
  ...
  const onFinish = async (values: LoginPayload) => {
    ...
    try {
      ...
      if (user.role === "ortu" || user.role === "orangtua")
        navigate(roleConfig.redirectPath);
      else navigate("/login");
    } catch (error) {
      const errorMsg =
          ...
          >
            ...
            <div style={{ padding: "32px 32px 40px 32px" }}>
              ...
              >
                ...
                >
                  <Input
                    prefix={<UserOutlined style={{ color: "#910000" }} />}
                    ...
                    onFocus={(e) => {
                      e.target.style.borderColor = "#910000";
                ...
                >
                  <Input.Password
                    prefix={<LockOutlined style={{ color: "#910000" }} />}
                    ...
                    onFocus={(e) => {
                      e.target.style.borderColor = "#910000";
                      e.target.style.boxShadow = "0 0 0 2px rgba(145,0,0,0.1)";
                    }}
                    onBlur={(e) => {
                      e.target.style.borderColor = "#e0e0e0";
                      e.target.style.boxShadow = "none";
