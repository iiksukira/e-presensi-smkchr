...
const PermissionStudent: React.FC = () => {
  usePageTitle("Pengajuan Izin Siswa");
    ...
    switch (type) {
      ...
      case "leave":
        return {
          required: true,
          message:
            "Wajib upload surat izin orang tua (max 2MB, format JPG/PNG/PDF)",
          maxFiles: 1,
          label: "Surat Izin",
        };
      case "business":
        return {
          required: true,
          message:
            "Wajib upload minimal 2 foto/surat keterangan (max 2MB per file)",
          maxFiles: 4,
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      await api.post("/student/permits", permitData);
  ...
  const handleUpdate = async (values: any) => {
    ...
    try {
      ...
      await api.put(`/student/permits/${selectedPermit.id}`, permitData);
  ...
  const getFileCount = (record: StudentPermit) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: StudentPermit, b: StudentPermit) =>
  ...
  return (
    <div style={{ textAlign: "left" }}>
      ...
      >
        <Space wrap>
          ...
          >
            <Option value="sick">
              <Space size={4}>
                <MedicineBoxOutlined style={{ color: token.colorError }} />
                <span>Sakit</span>
              </Space>
            </Option>
            <Option value="leave">
              <Space size={4}>
                <HomeOutlined style={{ color: token.colorWarning }} />
                <span>Cuti</span>
              </Space>
            </Option>
      ...
      {}
      <Modal
        title={<Text strong>Ajukan Izin Baru</Text>}
        open={isModalVisible}
        onCancel={() => {
          setIsModalVisible(false);
          form.resetFields();
        ...
        >
          ...
          >
            ...
            >
              ...
              <Option value="leave">
                <Space>Cuti (wajib surat izin orang tua)</Space>
              </Option>
              <Option value="business">
      ...
      {}
      <Modal
        title={`Preview Lampiran - ${selectedPermit?.typeLabel || "Siswa"}`}
...
export default PermissionStudent;
